...
// Test script details: Retrieving details for all users
...
test('Test get all users with token authentication', async ({ request }) => {
  ...
  expect(firstProduct).toHaveProperty('type', 'users');
  expect(firstProduct).toHaveProperty('attributes');
  expect(firstProduct.attributes).toHaveProperty('firstName', usersupdatefirstName);
