...
// Test script details: Creating a new user
...
const apiUrl = testData.createuserurl;
const usersfirstName = testData.userfirstName;
const userslastName = testData.userlastName;
const authToken = 'your-authentication-token-here';

test('Test adding a new user with token authentication', async ({ request }) => {
    ...
    data: 
    {
        "data": {
            ...
            "attributes": {
                ...
                "email": 'usertest' + randomNumber + '@keygen.sh',
                 "password": "test12345"
            }
        }
    }
  ...
  console.log('Response Body:', responseBody);
    ...
    expect(responseBody.data.attributes.firstName).toBe(usersfirstName); 
